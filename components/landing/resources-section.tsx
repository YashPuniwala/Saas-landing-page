...
export function ResourcesSection() {
  ...
  return (
    <section id="resources" className="py-16 md:py-24 relative bg-white dark:bg-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Marketing Insights &
            <span className="bg-gradient-to-r from-emerald-600 to-blue-600 dark:from-emerald-500 dark:to-blue-500 bg-clip-text text-transparent">
              {" "}Best Practices
            </span>
          </motion.h2>
          ...
          <GlassCard className="overflow-hidden hover:shadow-xl transition-all duration-300">
            <div className="flex flex-col lg:flex-row">
              <div className="lg:w-1/2 h-48 md:h-64 lg:h-auto">
                <motion.div
                  className="h-full bg-gradient-to-br from-blue-500 to-purple-600 dark:from-blue-600 dark:to-purple-700 flex items-center justify-center"
              ...
              <div className="lg:w-1/2 p-6 md:p-8 lg:p-10">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-slate-100 mb-3 md:mb-4">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                  <div className="flex items-center">
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-r from-blue-500 to-purple-500 dark:from-blue-600 dark:to-purple-600 rounded-full flex items-center justify-center mr-3 md:mr-4">
                      <span className="text-white font-semibold text-sm md:text-base">AJ</span>
                    </div>
                    <div>
                      <div className="font-semibold text-slate-900 dark:text-slate-100 text-sm md:text-base">Alex Johnson</div>
                      <div className="text-xs md:text-sm text-slate-600 dark:text-slate-400">Head of Marketing Research</div>
                    </div>
                  </div>
          ...
          {categories.map((category, index) => (
            ...
            >
              <GlassCard className="p-3 sm:p-4 md:p-6 text-center group cursor-pointer hover:shadow-lg transition-all duration-300 h-full">
                ...
                <h3 className="text-sm sm:text-base md:text-lg font-bold text-slate-900 dark:text-slate-100 mb-1 sm:mb-2">{category.title}</h3>
                <p className="text-xs text-slate-600 dark:text-slate-400 mb-1 sm:mb-2 md:mb-3">{category.description}</p>
            ...
            >
              <GlassCard className="overflow-hidden group cursor-pointer hover:shadow-lg transition-all duration-300">
                <div className="relative">
                  <motion.div
                    className="h-40 md:h-48 bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-700 flex items-center justify-center"
                ...
                <div className="p-4 md:p-6">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-slate-900 dark:text-slate-100 mb-2 md:mb-3 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                    {article.title}
                  </h3>
                  <p className="text-xs md:text-sm text-slate-600 dark:text-slate-400 mb-2 md:mb-3">{article.excerpt}</p>
        ...
        >
          <GlassCard className="p-6 md:p-8 lg:p-10 text-center">
            ...
            <p className="text-base md:text-lg text-slate-600 dark:text-slate-400 mb-6 md:mb-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 max-w-md mx-auto">
              <Input
                ...
                className="flex-1 h-10 md:h-12 text-sm md:text-base bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700"
              />
              <GradientButton variant="primary" className="whitespace-nowrap h-10 md:h-12 text-sm md:text-base">
                Subscribe
              </GradientButton>
            </div>
            <p className="text-xs text-slate-500 dark:text-slate-500 mt-3 md:mt-4">No spam, unsubscribe anytime.</p>
          </GlassCard>
        </motion.div>
      </div>
    </section>
